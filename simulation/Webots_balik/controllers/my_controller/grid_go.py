...
def gridGo(robot_coords, target_coords, heading):
    '''
    IN PROGRESS
    ...
    traj_dir=traj_vec/magnitude #normalize the vector to get direction
...
while robot.step(timestep) != -1:
    ...
    if not motion_planned:
        plan=gridGo(location[0:1], target_coords, heading) #get how much to rotate and how much to go
        #execute those
